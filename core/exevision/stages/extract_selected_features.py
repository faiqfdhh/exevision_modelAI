...
MODEL_PATH = os.environ.get("EXEVISION_MODEL_PATH", os.path.join('models', 'runtime_pose_and_face', 'pose_landmarker_heavy.task'))
FACE_MODEL_PATH = os.environ.get("EXEVISION_FACE_MODEL_PATH", os.path.join('models', 'runtime_pose_and_face', 'blaze_face_short_range.tflite'))
