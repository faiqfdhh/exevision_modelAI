...
SAVE_PATH = "models/bilstm_ohp_pretrained.pt"
DEFAULT_FEATURES_DIR = r"D:\FitnessAQA\ohp_phase1\workspace\overhead_press\extracted_features_clean\raw_unfiltered"
DEFAULT_SEGMENTED_DIR = r"D:\FitnessAQA\ohp_phase1\workspace\overhead_press\segmented_reps\raw_unfiltered"
...
def train(args):
    ...
    features_dir = _resolve_data_dir(args.features_dir, "training/overhead_press")
    segmented_dir = _resolve_data_dir(args.segmented_dir, "training/overhead_press/segmented_reps")
...
def parse_args():
    parser = argparse.ArgumentParser(description="BiLSTM masked reconstruction pretraining for overhead press")
