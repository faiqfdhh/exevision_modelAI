...
def get_view_weights_and_thresholds(view: str) -> Tuple[Dict[str, float], Dict[str, Dict[str, float]]]:
    ...
    if "side" in view_lower and "front" not in view_lower and "back" not in view_lower:
        ...
        thresholds = {
            ...
            "forward_lean": {"good": 30.0, "bad": 60.0, "higher_is_better": False},  # Stricter (clear view)
            "depth": {"good": 70.0, "bad": 120.0, "higher_is_better": False},  # Stricter (clear view)
    ...
    # FRONT/BACK VIEW: Best for valgus and hip shift; moderate depth; poor lean
        ...
        thresholds = {
            ...
            "forward_lean": {"good": 25.0, "bad": 50.0, "higher_is_better": False},  # Lenient (poor view)
            "depth": {"good": 100.0, "bad": 130.0, "higher_is_better": False},  # Moderate
